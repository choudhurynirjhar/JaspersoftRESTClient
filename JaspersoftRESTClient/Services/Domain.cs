...
namespace JaspersoftRESTClient
{
    class Domain
    {
        ...
        public Domain(string organizationId)
        {
        ...
        public bool Exists()
        {
            ...
            {
                request = WebRequest.Create("http://localhost:8080/jasperserver-pro/rest/resources/organizations/organisation_142/Domains?q=domain_142") as HttpWebRequest;
                request.CookieContainer = cookieContainer;
                request.Method = "GET";
        ...
        public void Create(string organizationId)
        {
            if (_tanent != null)
            {
                ...
                if (response.StatusCode == HttpStatusCode.OK)
                {
                    ...
                    request = WebRequest.Create("http://localhost:8080/jasperserver-pro/rest/resources/organizations/") as HttpWebRequest;
                    request.CookieContainer = cookieContainer;
                    request.Method = "PUT";
